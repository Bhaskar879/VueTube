...
function PlayingVideo() {
  ...
  return (
    <div className=" flex justify-center flex-row h-[calc(100%-56px)] mt-12">
      <div className="w-full max-w-[1270px] flex flex-col lg:flex-row">
        <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[100%-400px] px-4 py-3 lg:py-6">
          ...
          <div className="font-bold text-sm md:text-xl mt-2 line-clamp-2">
            {video?.title}
          </div>
          <div className="flex justify-between flex-col md:flex-row mt-2">
            ...
            <div className="flex mt-4 md:mt-0">
              ...
              <div className="flex items-center justify-center h-11 px-6 rounded-3xl bg-gray-200 ml-4">
